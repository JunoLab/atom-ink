    ...
    return <div>
      <div className="workspace-header">
        <span className="header-main">
          ...
          <span className="btn-group refresh-button"><Button alt='Refresh' icon="repo-sync" onclick={() => this.refresh()}/></span>
          <span className="btn-group module-button"><Button alt='Set Module' icon="package" onclick={() => this.refreshModule()}/></span>
        </span>
      </div>
