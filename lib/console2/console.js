...
export default class InkTerminal extends PaneItem {
  ...
  attach (ty, clear = false, cwd = '') {
    ...
    this.onResize = this.terminal.onResize(size => this.ty.resize(size.cols, size.rows))
  ...
  detach () {
    if (this.ty != undefined) {
      if (this.onData != undefined) this.onData.dispose()
      if (this.tyResize != undefined) this.tyResize.dispose()
      this.ty = undefined
    }
  }
