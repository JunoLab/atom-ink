    ...
    if (this.isLoading) {
      ...
      itemViews = <div className="items">
        <table>{
          ...
          items.map((item) =>
            <tr>
              <td className="typ" style={`font-family: ${this.codeFontFamily};`}>{this.icon(item)}</td>
              <td className="mod" style={`font-family: ${this.codeFontFamily};`}>{item.mod}</td>
              <td className="name" style={`font-family: ${this.codeFontFamily};`} onclick={item.onClickName}>{item.name}</td>
