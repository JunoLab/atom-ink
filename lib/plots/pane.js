  ...
  render() {
    ...
    let buttons = [
      <div className='btn-group'>
        <Button icon='move-left' alt='First' disabled = {this.items.length == 0} onclick={() => this.activateItem(0)}/>
        ...
        <Button icon='move-right' alt='Last'  disabled = {this.items.length == 0} onclick={() => this.activateItem(this.items.length - 1)}/>
      </div>,
      <div className='btn-group'>
